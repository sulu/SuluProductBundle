 ...
 * @internal
 */
class AttributeSetAdmin extends Admin
{
    public const SECURITY_CONTEXT = 'sulu.product.attribute_sets';
    public const LIST_VIEW = 'sulu_product.attribute_set.list';
    public const ADD_TABS_VIEW = 'sulu_product.attribute_set.add_tabs';
    public const EDIT_TABS_VIEW = 'sulu_product.attribute_set.edit_tabs';
    ...
    public function configureViews(ViewCollection $viewCollection): void
    {
        ...
        $viewCollection->add(
            $this->viewBuilderFactory->createListViewBuilder(static::LIST_VIEW, '/:locale/attribute-sets')
                ->setResourceKey(AttributeSetInterface::RESOURCE_KEY)
                ->setListKey(AttributeSetInterface::LIST_KEY)
        ...
        $viewCollection->add(
            $this->viewBuilderFactory->createResourceTabViewBuilder(static::ADD_TABS_VIEW, '/:locale/attribute-sets/add')
                ->setResourceKey(AttributeSetInterface::RESOURCE_KEY)
                ->addLocales($locales)
        ...
        $viewCollection->add(
            $this->viewBuilderFactory->createResourceTabViewBuilder(static::EDIT_TABS_VIEW, '/:locale/attribute-sets/:id')
                ->setResourceKey(AttributeSetInterface::RESOURCE_KEY)
                ->addLocales($locales)
                ->setBackView(static::LIST_VIEW)
        ...
        $viewCollection->add(
            $this->viewBuilderFactory->createFormViewBuilder(static::ADD_TABS_VIEW . '.details', '/details')
                ->setResourceKey(AttributeSetInterface::RESOURCE_KEY)
                ->setFormKey(AttributeSetInterface::FORM_KEY)
