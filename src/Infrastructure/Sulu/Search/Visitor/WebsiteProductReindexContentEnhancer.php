 ...
 * @final
 */
class WebsiteProductReindexContentEnhancer implements WebsiteProductReindexProviderEnhancerInterface
{
    ...
    private function getTemplateFormMetadata(string $templateKey, string $locale): ?FormMetadata
    {
        ...
        $formMetadata = $this->formMetadataProvider->getMetadata('product', $locale, []);
