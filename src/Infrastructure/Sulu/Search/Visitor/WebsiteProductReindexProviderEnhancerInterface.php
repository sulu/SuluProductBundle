 ...
 * for website product dimension content during search indexing.
 */
interface WebsiteProductReindexProviderEnhancerInterface
{
    /**
    ...
    /**
     * Enhance and manipulate the reindex data for an product dimension content.
     *
     * @param array<string, mixed> $queryResult The raw query result containing product data
