...
class CreateProductFamilyMessageTest extends TestCase
{
    public function testGettersExposeData(): void
    {
        $data = [
            ...
            'name' => 'My Family',
            'description' => 'desc',
            'attributes' => [['id' => 'uuid-5', 'required' => true, 'variantSpecific' => false, 'filterable' => false]],
        ];
        ...
        $this->assertSame([['id' => 'uuid-5', 'required' => true, 'variantSpecific' => false, 'filterable' => false]], $message->getAttributes());
