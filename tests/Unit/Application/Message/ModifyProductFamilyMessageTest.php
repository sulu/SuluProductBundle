...
class ModifyProductFamilyMessageTest extends TestCase
{
    public function testGettersExposeIdentifierAndData(): void
    {
        $message = new ModifyProductFamilyMessage(
            ['uuid' => 'family-uuid'],
            ['locale' => 'en', 'name' => 'X', 'attributes' => [1 => ['enabled' => true, 'required' => false, 'variant' => false]]],
        );
        ...
        $this->assertSame([1 => ['enabled' => true, 'required' => false, 'variant' => false]], $message->getAttributes());
        $this->assertSame(['locale' => 'en', 'name' => 'X', 'attributes' => [1 => ['enabled' => true, 'required' => false, 'variant' => false]]], $message->getData());
    }
}
