...
class ModifyProductFamilyMessageTest extends TestCase
{
    public function testGettersExposeIdentifierAndData(): void
    {
        $message = new ModifyProductFamilyMessage(
            ['uuid' => 'family-uuid'],
            ['locale' => 'en', 'name' => 'X', 'attributes' => [['id' => 'uuid-1', 'required' => false, 'variantSpecific' => false, 'filterable' => false]]],
        );
        ...
        $this->assertSame([['id' => 'uuid-1', 'required' => false, 'variantSpecific' => false, 'filterable' => false]], $message->getAttributes());
        $this->assertSame(['locale' => 'en', 'name' => 'X', 'attributes' => [['id' => 'uuid-1', 'required' => false, 'variantSpecific' => false, 'filterable' => false]]], $message->getData());
    }
}
