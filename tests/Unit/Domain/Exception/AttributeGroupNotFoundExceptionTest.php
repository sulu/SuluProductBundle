...
#[CoversClass(AttributeGroupNotFoundException::class)]
class AttributeGroupNotFoundExceptionTest extends TestCase
{
    public function testMessageContainsCriteria(): void
    {
        $e = new AttributeGroupNotFoundException(['uuid' => 'abc-123']);
