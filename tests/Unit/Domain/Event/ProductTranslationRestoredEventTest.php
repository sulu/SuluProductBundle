...
#[CoversClass(ProductTranslationRestoredEvent::class)]
class ProductTranslationRestoredEventTest extends TestCase
{
    ...
    private array $payload = ['restored' => true];

    private ProductTranslationRestoredEvent $event;

    protected function setUp(): void
    {
        $this->product = new Product(new ProductFamily(), 'uuid-translation-restored');
        $this->event = new ProductTranslationRestoredEvent($this->product, $this->locale, $this->payload);
    }
    ...
    {
        $this->assertSame('translation_restored', $this->event->getEventType());
    }
    ...
    {
        $this->assertSame('uuid-translation-restored', $this->event->getResourceId());
    }
