...
#[CoversClass(ProductTranslationAddedEvent::class)]
class ProductTranslationAddedEventTest extends TestCase
{
    ...
    private ProductTranslationAddedEvent $event;
    ...
    {
        $this->assertSame('translation_added', $this->event->getEventType());
    }
    ...
    {
        $this->assertSame('uuid-translation-added', $this->event->getResourceId());
    }
