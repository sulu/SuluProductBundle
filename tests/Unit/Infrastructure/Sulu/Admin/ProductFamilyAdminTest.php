...
#[CoversClass(ProductFamilyAdmin::class)]
class ProductFamilyAdminTest extends TestCase
{
    use ProphecyTrait;
    ...
    private ProductFamilyAdmin $admin;
    ...
    public function testGetSecurityContexts(): void
    {
        ...
        $this->assertArrayHasKey(ProductFamilyAdmin::SECURITY_CONTEXT, $contexts['Sulu']['Product']);
        $this->assertSame([
            PermissionTypes::VIEW,
            PermissionTypes::ADD,
            PermissionTypes::EDIT,
            PermissionTypes::DELETE,
        ], $contexts['Sulu']['Product'][ProductFamilyAdmin::SECURITY_CONTEXT]);
    }
    ...
    public function testConfigureViewsWithFullPermissions(): void
    {
        ...
        $this->assertTrue($viewCollection->has(ProductFamilyAdmin::ADD_TABS_VIEW));
        $this->assertTrue($viewCollection->has(ProductFamilyAdmin::EDIT_TABS_VIEW));
        $this->assertTrue($viewCollection->has(ProductFamilyAdmin::ADD_TABS_VIEW . '.details'));
        $this->assertTrue($viewCollection->has(ProductFamilyAdmin::EDIT_TABS_VIEW . '.details'));
    }

    public function testConfigureViewsWithoutAddAndDeletePermission(): void
    {
        $this->securityChecker->hasPermission(ProductFamilyAdmin::SECURITY_CONTEXT, PermissionTypes::EDIT)
            ->willReturn(true);
        $this->securityChecker->hasPermission(ProductFamilyAdmin::SECURITY_CONTEXT, PermissionTypes::ADD)
