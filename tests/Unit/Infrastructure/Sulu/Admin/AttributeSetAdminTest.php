...
#[CoversClass(AttributeSetAdmin::class)]
class AttributeSetAdminTest extends TestCase
{
    use ProphecyTrait;
    ...
    private AttributeSetAdmin $admin;
    ...
    protected function setUp(): void
    {
        ...
        $this->admin = new AttributeSetAdmin(
    ...
    public function testGetSecurityContexts(): void
    {
        ...
        $this->assertArrayHasKey(AttributeSetAdmin::SECURITY_CONTEXT, $contexts['Sulu']['Product']);
        $this->assertSame([
            PermissionTypes::VIEW,
            PermissionTypes::ADD,
            PermissionTypes::EDIT,
            PermissionTypes::DELETE,
        ], $contexts['Sulu']['Product'][AttributeSetAdmin::SECURITY_CONTEXT]);
    }

    public function testConfigureViewsSkippedWithoutEditPermission(): void
    {
        $this->securityChecker->hasPermission(AttributeSetAdmin::SECURITY_CONTEXT, PermissionTypes::EDIT)
            ->willReturn(false);
    ...
    public function testConfigureViewsAddsListView(): void
    {
        $this->securityChecker->hasPermission(AttributeSetAdmin::SECURITY_CONTEXT, PermissionTypes::EDIT)
            ->willReturn(true);
        $this->securityChecker->hasPermission(AttributeSetAdmin::SECURITY_CONTEXT, PermissionTypes::ADD)
            ->willReturn(false);
        $this->securityChecker->hasPermission(AttributeSetAdmin::SECURITY_CONTEXT, PermissionTypes::DELETE)
            ->willReturn(false);

        $viewCollection = new ViewCollection();
        $this->admin->configureViews($viewCollection);

        $this->assertTrue($viewCollection->has(AttributeSetAdmin::LIST_VIEW));
    ...
    public function testConfigureViewsAddsAddTabsView(): void
    {
        ...
        $this->assertTrue($viewCollection->has(AttributeSetAdmin::ADD_TABS_VIEW));
    }
    ...
    public function testConfigureViewsAddsEditTabsView(): void
    {
        ...
        $this->assertTrue($viewCollection->has(AttributeSetAdmin::EDIT_TABS_VIEW));
    }
    ...
    public function testConfigureViewsWithFullPermissions(): void
    {
        ...
        $this->assertTrue($viewCollection->has(AttributeSetAdmin::ADD_TABS_VIEW));
        $this->assertTrue($viewCollection->has(AttributeSetAdmin::EDIT_TABS_VIEW));
        $this->assertTrue($viewCollection->has(AttributeSetAdmin::ADD_TABS_VIEW . '.details'));
        $this->assertTrue($viewCollection->has(AttributeSetAdmin::EDIT_TABS_VIEW . '.details'));
    }
}
