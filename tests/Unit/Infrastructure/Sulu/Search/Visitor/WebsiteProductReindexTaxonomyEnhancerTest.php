...
class WebsiteProductReindexTaxonomyEnhancerTest extends TestCase
{
    use ProphecyTrait;

    private WebsiteProductReindexTaxonomyEnhancer $enhancer;

    protected function setUp(): void
    {
        $this->enhancer = new WebsiteProductReindexTaxonomyEnhancer();
    }
