...
class WebsiteProductReindexContentEnhancerTest extends TestCase
{
    use ProphecyTrait;
    ...
    private WebsiteProductReindexContentEnhancer $enhancer;

    protected function setUp(): void
    {
        $this->formMetadataProvider = $this->prophesize(MetadataProviderInterface::class);
        $this->enhancer = new WebsiteProductReindexContentEnhancer($this->formMetadataProvider->reveal());
    }
    ...
    public static function provideBlockScenarios(): array
    {
        return [
            'single block with one item' => [
                ...
                ['Product Title', 'First block text'],
                'single block with one item',
            ],
            'single block with multiple items' => [
                ...
                ['Product Title', 'First block', 'Second block', 'Third block'],
                'single block with multiple items',
            ],
            'blocks with HTML content' => [
                ...
                ['Product Title', 'Block with HTML', 'Another formatted text'],
                'blocks with HTML content',
            ],
            'empty block array' => [
                [
            ...
            'nested blocks (2 levels)' => [
                ...
                ['Product Title', 'Nested text content'],
                'nested blocks (2 levels)',
            ],
            'deeply nested blocks (3 levels)' => [
                ...
                ['Product Title', 'Deeply nested text'],
                'deeply nested blocks (3 levels)',
            ],
            'multiple nested blocks in list' => [
                ...
                ['Product Title', 'First nested', 'Second nested', 'Third nested'],
                'multiple nested blocks in list',
            ],
        ];
    }
