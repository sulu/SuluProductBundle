...
class WebsiteProductReindexExcerptEnhancerTest extends TestCase
{
    use ProphecyTrait;

    private WebsiteProductReindexExcerptEnhancer $enhancer;

    protected function setUp(): void
    {
        $this->enhancer = new WebsiteProductReindexExcerptEnhancer();
    }
