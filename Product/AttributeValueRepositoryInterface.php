...
use Sulu\Bundle\ProductBundle\Entity\AttributeValueInterface;
...
{
    /**
     * Finds the attribute value with the given ID
    ...
    /**
     * Finds the attribute value with the given ID in the given language
    ...
    /**
     * Returns all attribute values in the given locale
     * @param string $locale The locale of the attribute to load
     * @return AttributeInterface[]
     */
